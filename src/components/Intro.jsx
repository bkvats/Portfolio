        ...
        <div className="w-full flex flex-col justify-evenly items-center mt-20 lg:flex-row">
            ...
            <div>
                ...
                <div className="lg:ml-7 flex flex-wrap items-center justify-evenly lg:w-fit lg:gap-4">
                    <a href="https://drive.google.com/file/d/1IHP7-rPCwsw3C_5gIoGJlFVTiUq_NrWe/view?usp=sharing" className="flex items-center gap-2 border-2 border-[#C778DD] py-2 px-4" download={"BSharmaResume"} target="_blank">< ImDownload/>Download CV</a>
